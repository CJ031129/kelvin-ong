...
public class HotelManagementSystem {
    ...
    private static final String VALID_USERNAME = "kk";
    private static final String VALID_PASSWORD = "69420";
    ...
    private static void showMenu(String csvFilePath, Scanner scanner) {
        while (true) {
